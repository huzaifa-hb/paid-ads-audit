...
```json
{
  ...
  "sources": [{"provider": "Meta Ads", "account": "Account", "start": "YYYY-MM-DD", "end": "YYYY-MM-DD", "timezone": "America/New_York", "currency": "USD", "grain": "campaign/day", "filters": "active and paused", "attribution": "source-defined", "retrieved_at": "ISO-8601 timestamp", "completeness": "complete", "status": "complete", "notes": []}, {"provider": "Shopify", "account": "Store", "start": "YYYY-MM-DD", "end": "YYYY-MM-DD", "timezone": "America/New_York", "currency": "USD", "grain": "order", "filters": "non-cancelled orders", "attribution": "n/a", "retrieved_at": "ISO-8601 timestamp", "completeness": "complete", "status": "complete", "notes": []}],
