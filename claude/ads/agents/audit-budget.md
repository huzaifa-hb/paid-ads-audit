...
4b. If the account is e-commerce or DTC, also read `ads/references/dtc-ecommerce.md` for: learning phase budget adequacy math (Section 3), staged ROAS progression model (Section 2), and contribution margin break-even framework (Section 1)
