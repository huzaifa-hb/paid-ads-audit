...
- `references/image-providers.md`: API setup and pricing
- `references/brand-dna-template.md`: Brand injection schema
- `references/meta-creative-specs.md`: Safe zone for 9:16
- `references/tiktok-creative-specs.md`: Safe zone constraints
