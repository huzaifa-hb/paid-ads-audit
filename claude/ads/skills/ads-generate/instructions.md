...
Load `references/image-providers.md` to confirm:
...
- `references/meta-creative-specs.md`
- `references/google-creative-specs.md`
- `references/tiktok-creative-specs.md`
- `references/linkedin-creative-specs.md`
- `references/youtube-creative-specs.md`
- `references/microsoft-creative-specs.md`
...
- `references/image-providers.md`: provider config, pricing, limits
- `references/[platform]-creative-specs.md`: per-platform specs
- `references/brand-dna-template.md`: brand injection schema
