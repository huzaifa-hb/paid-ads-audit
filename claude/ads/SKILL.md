...
For individual commands (`/ads google`, `/ads meta`, etc.), read the relevant `skills/<name>/instructions.md` file directly. Still collect context first if not already provided.
