...
1. Follow `references/data-sources.md`; query the connected Microsoft Ads source first,
   using exports or diagnostics screenshots only for unavailable fields.
2. Read `references/microsoft-audit.md` for full 24-check audit
