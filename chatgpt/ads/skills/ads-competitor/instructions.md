...
Use connected first-party ad sources for Auction Insights or equivalent account-owned
evidence, and official public ad libraries or current web research for competitor
creative. Follow `references/data-sources.md`; do not infer exact competitor spend when
the source provides only estimates or ranges.
