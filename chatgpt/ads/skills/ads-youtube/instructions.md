...
1. Follow `references/data-sources.md`; query connected Google Ads data filtered to
   YouTube/video inventory, using exports only for unavailable fields.
2. Read `references/google-audit.md` for YouTube-relevant checks (incl. G-DG1 through G-DG3, G-CTV1)
