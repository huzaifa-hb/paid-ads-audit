...
1. Follow `references/data-sources.md`; obtain destination URLs from connected campaign
   data when available, then inspect them with the current web/browser capability.
