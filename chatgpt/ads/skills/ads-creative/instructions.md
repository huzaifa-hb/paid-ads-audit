...
1. Follow `references/data-sources.md`; collect creative assets, metadata, and aligned
   performance from connected platform sources before requesting uploads.
...
4. Read `references/scoring-system.md` for weighted scoring algorithm
