...
1. Follow `references/data-sources.md`; query the connected LinkedIn Ads source first,
   using Campaign Manager exports only for unavailable fields.
2. Read `references/linkedin-audit.md` for full 27-check audit
