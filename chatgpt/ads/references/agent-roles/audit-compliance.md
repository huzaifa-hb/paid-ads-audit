...
[Returns compliance-audit-results.md with regulatory risk flags and performance scores to the coordinator]
...
1. Read platform-specific audit checklists:
   - `references/linkedin-audit.md`: L14-L15 (Lead Gen Forms), L18-L25 (Structure & Performance)
   - `references/tiktok-audit.md`: T17-T19 (Performance)
   - `references/microsoft-audit.md`: MS14-MS18 (Settings & Performance)
2. Read `references/compliance.md` for full regulatory requirements
3. Read `references/benchmarks.md` for performance targets
4. Evaluate each applicable check as PASS, WARNING, or FAIL
5. Return detailed findings to the coordinator
...
- Read `references/compliance.md` for full category requirements
