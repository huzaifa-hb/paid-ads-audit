...
[Returns tracking-audit-results.md with per-platform scores and gap analysis to the coordinator]
...
1. Read platform-specific audit checklists:
   - `references/linkedin-audit.md`: L01-L02 (Technical Setup)
   - `references/tiktok-audit.md`: T01-T02 (Technical Setup)
   - `references/microsoft-audit.md`: MS01-MS03 (Technical Setup)
2. Read `references/conversion-tracking.md` for implementation details
