...
[Returns meta-audit-results.md with score, findings, EMQ recommendations, and creative fatigue alerts to the coordinator]
...
1. Read `references/meta-audit.md` for the full 50-check audit checklist
2. Read `references/benchmarks.md` for Meta-specific benchmarks by objective
2b. If the account is e-commerce or DTC, also read `references/dtc-ecommerce.md` for: contribution margin break-even methodology (Section 1), staged ROAS progression model (Section 2), new-customer ROAS isolation (Section 4), MER trend diagnostic (Section 5), creative fatigue vs saturation distinction (Section 6), and performance drop triage sequence (Section 9)
