...
[Returns creative-audit-results.md with per-platform scores and cross-platform synthesis to the coordinator]
...
1. Read platform-specific audit checklists:
   - `references/linkedin-audit.md`: L10-L13 (Creative & Formats)
   - `references/tiktok-audit.md`: T05-T10, T20-T25 (Creative Quality)
   - `references/microsoft-audit.md`: MS11-MS13, MS19-MS20 (Creative & Extensions)
2. Read `references/platform-specs.md` for creative specifications
3. Read `references/benchmarks.md` for CTR/engagement benchmarks
