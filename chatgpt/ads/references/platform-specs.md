...
<!-- Compiled reference: verify current specifications before production delivery. -->
...
Working range: 8-10 headlines and 2-3 descriptions; verify current platform guidance
before treating a larger asset count as a quality requirement.
