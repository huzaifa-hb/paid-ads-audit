...
specific aesthetic attributes that become the [STYLE] component in native image prompts.
...
5. Append the [STYLE] string to the native image prompt before generation.
