...
Still-image generation can create thumbnails, companion banners, static assets, and
storyboard frames. Generate video only when a video-generation capability is available
in the current surface; otherwise deliver the storyboard, shot list, script, and prompts.
